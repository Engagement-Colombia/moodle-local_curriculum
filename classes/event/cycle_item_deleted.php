...
/**
 * Event for when a cycle item is deleted
 *
 * @package    local_curriculum
 * @copyright  2026 David Herney @ BambuCo
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class cycle_item_deleted extends \core\event\base {
    /**
    ...
    public function get_description() {
        return "The user with id '$this->userid' deleted the cycle item with id '$this->objectid'.";
    }
