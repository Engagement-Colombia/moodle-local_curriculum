 ...
 */
class version_deleted extends \core\event\base {
    /**
    ...
    public static function get_name() {
        return get_string('eventversion_deleted', 'local_curriculum');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' deleted the version with id '$this->objectid'.";
    }
